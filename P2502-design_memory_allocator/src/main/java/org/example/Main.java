 ...
 * @LastEditTime: 2025-02-25 16:22:55
...
public class Main {
    public static void main(String[] args) {
        ...
        int res = loc.allocate(1, 1); // The leftmost block's first index is 0. The memory array becomes [1,_,_,_,_,_,_,_,_,_]. We return 0.
